function enviarMensagem(nr_celular, tx_mensagem) {
    var celular = nr_celular;
    //celular = celular.replace(/\D/g, ''); //Deixar apenas n̼meros

    //Verificar se tem DDI e adicionar se ṇo tiver
    //if (celular.length < 13) {
    celular = "55" + celular;
    //}

    var texto = tx_mensagem;
